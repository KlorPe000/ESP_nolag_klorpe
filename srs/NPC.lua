...
for i, v in pairs(game.Players:GetChildren()) do
    ...
    Top.Color = Color3.fromRGB(255, 255, 255)  -- Белый цвет
    Top.Thickness = 2
    Top.Transparency = 1
    ...
    Bottom.Color = Color3.fromRGB(255, 255, 255)  -- Белый цвет
    Bottom.Thickness = 2
    ...
    Left.Color = Color3.fromRGB(255, 255, 255)  -- Белый цвет
    Left.Thickness = 2
    Left.Transparency = 1
    ...
    Right.Color = Color3.fromRGB(255, 255, 255)  -- Белый цвет
    Right.Thickness = 2
